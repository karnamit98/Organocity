       ...
       <div class="container"><!-- container Begin -->
           ...
           <?php
               ...
               if(isset($_SESSION['user_id']))
                    ...
                    echo '<a href="my_account.php" style="color:#f8dc88"> 
           ...
           <div class="col-md-6"><!-- col-md-6 Begin -->
               ...
               <ul class="menu"><!-- cmenu Begin -->
                        ...
                        <?php
                            ...
                            else
                            {
                                if($curPageName == "my_account.php")
                                    echo '<a href="my_account.php" style="border-bottom:1px solid #fffdbb;color:#fffdbb;"><img src="customer_images/'.$uimg.'" class="img-circle img-responsive" style="float:left;width:20px;height:20px;margin-right:8px !important;" >
                                      '.$_SESSION['userfullname'].'</a>';
                                else
                                    echo '<a href="my_account.php">
                                    <img src="customer_images/'.$uimg.'" class="img-circle img-responsive" style="float:left;width:20px;height:20px;margin-right:8px !important;" >
                                    '.$_SESSION['userfullname'].'</a>';
                   ...
                   <?php
                            //if($curPageName == "my_account.php")
                           // echo '<a href="my_account.php" style="border-bottom:1px solid #fffdbb;color:#fffdbb;"><i class="fa fa-user"></i>  My Account</a>';
                           // else
                           // echo '<a href="my_account.php"><i class="fa fa-user"></i>  My Account</a>';
                        ?>
                   </li-->
                   <li>
                        <?php
                   ...
                   <!--li>
                        <?php
                            //if($curPageName == "login.php")
                            //echo '<a href="../login.php" style="border-bottom:1px solid #fffdbb;color:#fffdbb;">Login</a>';
                            //else
                   ...
                   <li>
                        <?php
                            ...
                            echo '<a href="testomonial.php" style="border-bottom:1px solid #fffdbb;color:#fffdbb;"><i class="fa fa-asterisk"></i>Testomonial</a>';
                            else
                            echo '<a href="testomonial.php"><i class="fa fa-asterisk"></i> Testomonial</a>';
                        ?>
                   </li>
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-collapse collapse" id="navigation"><!-- navbar-collapse collapse Begin -->
               ...
               <div class="padding-nav"><!-- padding-nav Begin -->
                   ...
                   <ul class="nav navbar-nav left"><!-- nav navbar-nav left Begin -->
                       ...
                       <li>
                            <?php
                              //  if($curPageName == "my_account.php")
                              //  echo '<a href="my_account.php" class="active"><i class="fa fa-user"></i> My Account</a>';
                              //  else
                              //  echo '<a href="my_account.php"><i class="fa fa-user"></i> My Account</a>';
                              ...
                              if(isset($_SESSION['user_id']))
                                {
                                    if($curPageName == "my_account.php")
                                        echo '<li><a href="my_account.php" style="border-bottom:1px solid #fffdbb;color:#888888;" class="active"><i class="fa fa-user"></i>    My Account </a></li>';
                                    else
                                        echo '<li><a href="my_account.php"><i class="fa fa-user"></i>  My Account </a></li>';
                                }
                            ?>
               ...
               <div class="collapse clearfix" id="search"><!-- collapse clearfix Begin -->
                   ...
                   <form method="GET" action="../searchDisplay.php" enctype="multipart/get-data" class="navbar-form"><!-- navbar-form Begin -->
