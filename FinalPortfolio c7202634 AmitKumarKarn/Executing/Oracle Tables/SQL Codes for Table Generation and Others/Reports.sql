...
SELECT DISTINCT o.INVOICE_NO, TO_CHAR(ORDER_DATE, 'DAY, MM/DD/YYYY') DAY, c.SLOT_INFO COLLECTION_SLOT, o.COLLECTION_DATE, u.FULLNAME CUSTOMER, p.PAYMENT_AMOUNT AMOUNT
